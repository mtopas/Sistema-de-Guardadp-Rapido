...
function TopBar({ moduleId, onPrimary, onSettings, onCycle }) {
  ...
  return (
    ...
    >
      <button
        ...
        title="Click para cambiar de módulo"
        className="flex items-baseline rounded-md focus-ring transition-transform duration-150 hover:scale-[1.03] active:scale-95 cursor-pointer"
      >
        <div className="serif italic text-[28px] leading-none grad-text font-bold tracking-tight">
          {m.name.toUpperCase()}
        </div>
      </button>
