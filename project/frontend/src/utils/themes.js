...
export const THEMES = {
  ...
  'disco-90s': {
    ...
    '--sidebar':       '#09040f',
    '--surface':       '#1d1129',
    '--panel-bg':      'rgba(21,12,30,0.94)',
    '--header-cta-bg': 'linear-gradient(135deg, #f472b6, #a855f7 58%, #22d3ee)',
    '--header-avatar-bg': '#7c3aed',
    ...
    '--subtext':       '#b49abd',
    '--mute':          '#7a6485',
    '--cta-bg':        'linear-gradient(135deg, #f472b6 0%, #a855f7 54%, #22d3ee 100%)',
    '--cta-text':      '#ffffff',
    '--shadow-accent': '0 8px 24px -10px rgba(244,114,182,0.50)',
    '--shadow-soft':   '0 10px 28px rgba(4,1,8,0.42)',
  ...
  'blanco-negro': {
    ...
    '--sidebar':       '#050607',
    '--surface':       '#17191b',
    '--panel-bg':      'rgba(19,21,23,0.96)',
    '--header-cta-bg': 'linear-gradient(135deg, #ffffff, #d7d9dc)',
    '--header-avatar-bg': '#f4f4f5',
    ...
    '--subtext':       '#a6abb2',
    '--mute':          '#666b72',
    '--cta-bg':        'linear-gradient(135deg, #ffffff, #d7d9dc)',
    '--cta-text':      '#090a0b',
    '--shadow-accent': '0 8px 22px -12px rgba(255,255,255,0.30)',
    '--shadow-soft':   '0 10px 28px rgba(0,0,0,0.52)',
  ...
  'lima-gris': {
    ...
    '--sidebar':       '#070907',
    '--surface':       '#171a18',
    '--panel-bg':      'rgba(18,22,19,0.94)',
    '--header-cta-bg': 'linear-gradient(135deg, #d9f99d, #a3e635)',
    '--header-avatar-bg': '#a3e635',
    ...
    '--subtext':       '#979f97',
    '--mute':          '#5d665e',
    '--cta-bg':        'linear-gradient(135deg, #d9f99d, #a3e635)',
    '--cta-text':      '#10140c',
    '--shadow-accent': '0 8px 24px -12px rgba(190,242,100,0.38)',
    '--shadow-soft':   '0 10px 28px rgba(0,0,0,0.44)',
